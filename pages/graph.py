...
if 'market_data' in crypto_info:
    ...
    if 'ath' in crypto_info['market_data'] and 'ath_change_percentage' in crypto_info['market_data'] and 'ath_date' in crypto_info['market_data'] and 'ath_age' in crypto_info['market_data']:
    ...
    if 'atl' in crypto_info['market_data'] and 'atl_change_percentage' in crypto_info['market_data'] and 'atl_date' in crypto_info['market_data'] and 'atl_age' in crypto_info['market_data']:
